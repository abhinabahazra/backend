...
app1.post('/getHomeMovieDetailsByCategoryIdandText', async (req, res, next) => {
    let obj;
    //console.log('jiiii');
    let required = [];
    ...
    if (required.length === 0) {
        ...
        let movieDetails=await movieservices.findbasicMovieDetailsByTitleCat(id,txt_movie_title);
