	...
	if (req.file) {
       ...
       // console.log(checkUser);
		...
		if (getMovieLinkB1.status == "success") {
		  if (getMovieLinkB1.result.txt_cheque_link && getMovieLinkB1.result.txt_cheque_link != "" && getMovieLinkB1.result.txt_cheque_link != "undefined") {
			  obj = {
				status: "success",
				message: "Already exist txt_cheque_link File!",
				response: getMovieLinkB1.result.txt_cheque_link
			};
		  } else {
			  obj = {
				status: "fail",
